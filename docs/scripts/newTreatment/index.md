...
После получения пациента требуется добавить ЭМЗ [/ehr/add](../../methods/ehr/add/examples/add.md), затем добавить 
запись в ЭМЗ [/ehr/record/add](../../methods/ehr/record/add/examples/RcDz/add.md)
