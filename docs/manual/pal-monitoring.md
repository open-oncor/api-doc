...
| oid    | Строка  | [OID](https://nsi.rosminzdrav.ru/dictionaries/1.2.643.5.1.13.13.11.1461/) организации | "1.2.643.5.1.13.13.12.2.66.6868" |
...
3. Особые значения:
    - При нулевом denominator возвращается rate = null
