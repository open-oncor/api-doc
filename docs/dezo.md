...
1. [Сценарии работы внешней системы с API для ДЭЗО](#сценариb-работы-внешней-системы-с-api-для-дэзо)
...
4. Получение файла
    * [/attachment/get](methods/attachment/get) - `получаем и мета-информацию о файле и сам файл`
